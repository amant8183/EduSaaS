            ...
            <div className="relative bg-bg-surface border border-border rounded-2xl overflow-hidden shadow-sm">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-text-tertiary text-sm font-medium">No payments found</p>
                    </div>
                ) : (
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-border">
                                    ...
                                    <th className="text-left py-3 px-4 text-xs font-semibold text-text-tertiary uppercase tracking-wider">Payment ID</th>
                            ...
                            <tbody>
                                {payments.map((p) => (
                                    <tr key={p._id} className="border-b border-border/50 last:border-0 hover:bg-bg-elevated/40 transition-colors">
                                        ...
                                        <td className="py-3.5 px-4 text-text-tertiary font-mono text-xs">
                                        ...
                                        <td className="py-3.5 px-4">
                                            <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold ${p.status === "success" ? "bg-success/15 text-success"
